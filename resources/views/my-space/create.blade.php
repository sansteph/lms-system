    ...
    <div class="row">
        ...
        <div class="col-md-10 col-lg-10 p-4">
            ...
            <div class="page-header mb-4">
                <h2>Submit to My Space</h2>
                <p class="text-muted">
                    Upload an idea blueprint or share your project repository.
                </p>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST"
                          action="{{ session('user_role') == 'Teacher'
                                ? route('teacher.my-space.store')
                                : route('student.my-space.store') }}"
                        ...
                        <div class="mb-3 d-none" id="blueprintField">
                            ...
                            <small class="text-muted">
                                Required for ideas. Upload PDF only.
                            </small>
                        </div>

                        <div class="mb-3 d-none" id="repositoryField">
