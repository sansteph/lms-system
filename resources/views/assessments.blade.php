    ...
    <div class="row">
        ...
        <div class="col-md-10 col-lg-10 p-4">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3"><div class="dashboard-card"><h6>Total Assessments</h6><h2>{{ $assessments->count() }}</h2></div></div>
                <div class="col-md-3"><div class="dashboard-card"><h6>Pending Approval</h6><h2>{{ $assessments->where('question_paper_status', 'Pending Approval')->count() }}</h2></div></div>
                <div class="col-md-3"><div class="dashboard-card"><h6>Approved Papers</h6><h2>{{ $assessments->where('question_paper_status', 'Approved')->count() }}</h2></div></div>
                <div class="col-md-3"><div class="dashboard-card"><h6>Rejected Papers</h6><h2>{{ $assessments->where('question_paper_status', 'Rejected')->count() }}</h2></div></div>
            </div>
