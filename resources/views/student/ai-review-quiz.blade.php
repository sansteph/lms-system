        ...
        <div class="col-12 p-4 p-lg-5">
            ...
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    @else
                    <form id="lockedStudentReviewForm" action="{{ route('student.content.ai-review.submit', $content->id) }}" method="POST">
                        @csrf
                        <input type="hidden" name="auto_submitted" id="studentAutoSubmitted" value="0">
...
@unless($latestAttempt && $latestAttempt->status == 'passed')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const form = document.getElementById('lockedStudentReviewForm');
            const autoSubmitted = document.getElementById('studentAutoSubmitted');
            ...
            const submitForViolation = function () {
                ...
                showWarning('Third restricted action detected. Your training assessment is being submitted automatically.');
            ...
            const recordViolation = function () {
                ...
                showWarning('Warning ' + violationCount + ' of ' + allowedViolations + '. On the next restricted action, the training assessment will be submitted automatically.');
            };
